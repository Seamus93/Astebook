const settingsSections = [
    ...
    groups: [
      ...
      },
      {
        ...
        fields: [
          ...
          ["pdfAppAsyncMode", "pdf_app_async_mode", "PDF-app Async Mode", "auto", "off", "text", "auto usa async solo con Job Endpoint configurato; true forza async; false usa sync."],
          ["pdfAppPollTimeoutMs", "pdf_app_poll_timeout_ms", "PDF-app Poll Timeout Ms", "90000", "off", "number", "Timeout massimo del polling job OCR async."],
          ["pdfAppPollIntervalBaseMs", "pdf_app_poll_interval_base_ms", "PDF-app Poll Interval Base Ms", "1000", "off", "number", "Intervallo iniziale tra controlli dello stato job OCR."],
          ["pdfAppRetryCount", "pdf_app_retry_count", "PDF-app Retry Count", "2", "off", "number", "Retry su 502, 503, 504 e timeout/reset di rete."],
          ["pdfAppRetryBaseDelayMs", "pdf_app_retry_base_delay_ms", "PDF-app Retry Base Delay Ms", "1000", "off", "number", "Backoff iniziale per retry OCR PDF-app."],
  ...
  },
  {
    ...
    fields: [
      ...
      ["apifyImmobiliareActorId", "apify_immobiliare_actor_id", "Actor Immobiliare", "azzouzana/immobiliare-it-listing-page-scraper-by-items-urls", "off", "text", "ID dell'actor Apify da eseguire per leggere un annuncio Immobiliare.it. Per link /annunci/... usa la variante by-items-urls."],
      [
        ...
        "off",
        "text",
        "JSON opzionale inviato all'actor. Usa {url} come placeholder. Per by-search-url usa {\"startUrl\":\"{url}\",\"maxItems\":10}.",
      ],
    ],
  },
  {
