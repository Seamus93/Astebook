...
const expectedZapierFields = [
  ...
  { path: "extracted.proposta.catasto.foglio", label: "Catasto - Foglio", expected_file: "Proposta" },
  { path: "extracted.proposta.catasto.particella", label: "Catasto - Particella", expected_file: "Proposta" },
  { path: "extracted.proposta.catasto.subalterno", label: "Catasto - Subalterno", expected_file: "Proposta" },
